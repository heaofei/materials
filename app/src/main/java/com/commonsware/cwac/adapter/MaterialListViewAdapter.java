...
import com.example.administrator.materials.R;
 ...
 */
public class MaterialListViewAdapter extends ArrayAdapter<String> {
    public MaterialListViewAdapter(final Context context, List<Card> cards) {
